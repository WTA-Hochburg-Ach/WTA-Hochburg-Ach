  ...
  const TRANSLATIONS = {
    de: {
      ...
      nav: {
        ...
        links: 'Links',
        links_summary: 'Externe Links und Netzwerk. Wird noch ergaenzt.',
        contact: 'Kontakt',
    ...
    en: {
      ...
      nav: {
        ...
        links: 'Links',
        links_summary: 'External links and network. Coming soon.',
        contact: 'Contact',
    ...
    fr: {
      ...
      nav: {
        ...
        links: 'Liens',
        links_summary: 'Liens externes et reseau. Bientot complete.',
        contact: 'Contact',
